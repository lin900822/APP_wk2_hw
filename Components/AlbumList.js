    ...
    <ScrollView>
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          <View style={styles.headerContentStyle}>
            <Text style={styles.fontBold}>{albumData[0].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.fontBold}>{albumData[1].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.fontBold}>{albumData[2].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.fontBold}>{albumData[3].title}</Text>
      ...
      <View style={styles.cardContainerStyle}>
        <View style={[styles.thumbnailContainerStyle, styles.cardSectionStyle]}>
          ...
          />
          <View style={styles.headerContentStyle}>
            <Text style={styles.fontBold}>{albumData[4].title}</Text>
